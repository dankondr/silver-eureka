    ...
    if (res > 0) {
      switch (event.type) {
        case ENET_EVENT_TYPE_RECEIVE: {
          ...
          // TODO: - Отключение пользователя во время приема пакета
//          if (peer->address in addresses_to_disconnect) {
//            вывод в консоль информации об отключении
//            Если в данных мы хранили id пользователя то нужно peer->NULL
...
//          }
        ...
        case ENET_EVENT_TYPE_CONNECT:
          ...
          // TODO: - Вывод в терминал ip подключенного клиента
          // std::cout << "User connected: "sv << peer->address.host;
          // можно также добавить peer какие то данные через peer->data = "data";
          // только затем ее нужно удалить через peer->data = NULL при отключении
          break;
